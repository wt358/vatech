...
if __name__=="__main__":
    ...
    fake=Faker() # Initialize faker module
    ...
    for i in range(100000):
        ...
        if hospital[1]=="Vatech":
            doctor=random.choice(list_doctor[:200]) # 200 dentists in Vatech
        elif hospital[1]=="Samsung":
            doctor=random.choice(list_doctor[200:350]) # 150 dentists in Samsung
        else:
            doctor=random.choice(list_doctor[350:]) # 150 dentists in other dental clinic
